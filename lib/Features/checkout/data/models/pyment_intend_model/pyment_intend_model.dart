...
class PymentIntendModel {
  ...
  factory PymentIntendModel.fromJson(Map<String, dynamic> json) {
    return PymentIntendModel(
  ...
  Map<String, dynamic> toJson() => {
        ...
        'payment_method_types': paymentMethodTypes as List<dynamic>?,
